...
public final class ExampleUiRegistration {
    ...
    public static void registerExamples() {
        ResourceLocation html = ResourceLocation.fromNamespaceAndPath(UI_ID.getNamespace(), "assets/webcraftui/html/example_inventory.html");
        ResourceLocation css = ResourceLocation.fromNamespaceAndPath(UI_ID.getNamespace(), "assets/webcraftui/css/default_minecraft_ui.css");
        ...
        ResourceLocation hudHtml = ResourceLocation.fromNamespaceAndPath(UI_ID.getNamespace(), "assets/webcraftui/html/hud_status.html");
